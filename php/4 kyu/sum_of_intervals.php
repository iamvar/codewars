...
/**
 * @link https://www.codewars.com/kata/sum-of-intervals
 *
 ...
 *
 *
 * I also have oneliner solution, but I do not like it
 * return count(array_reduce($intervals, fn($carry, $i) => $carry + array_flip(range($i[0], $i[1] - 1)), []));
 */
function sum_intervals(array $intervals): int
{
    $res = [];
    foreach ($intervals as $i) {
        $res += array_flip(range($i[0], $i[1] - 1));
    }
